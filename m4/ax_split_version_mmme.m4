...
# SYNOPSIS
#
#   AX_SPLIT_VERSION_MMME(VERSION, [MAJOR, [MINOR, [MICRO, [EXTRA]]]])
#
# DESCRIPTION
#
...
#   Examples:
#
#     AX_SPLIT_VERSION_MMME("1",[MAJOR])
#     AX_SPLIT_VERSION_MMME("1-a",[MAJOR],,,[EXTRA])
#     AX_SPLIT_VERSION_MMME("1.2",[MAJOR],[MINOR])
#     AX_SPLIT_VERSION_MMME("1.2.3",[MAJOR],,[MICRO])
#     AX_SPLIT_VERSION_MMME("1.2-alfa",[MAJOR],[MINOR],,[EXTRA])
#     AX_SPLIT_VERSION_MMME("1.33.4444",[MAJOR],[MINOR],[MICRO])
#     AX_SPLIT_VERSION_MMME("12.44.333111-alfa",[MAJOR])
#     AX_SPLIT_VERSION_MMME("12.44.333111-alfa",,[MINOR])
#     AX_SPLIT_VERSION_MMME("12.44.333111-alfa",,,[MICRO])
#     AX_SPLIT_VERSION_MMME("12.44.333111-alfa",,,,[EXTRA])
#
# LICENSE
#
...
AC_DEFUN([AX_SPLIT_VERSION_MMME],[
